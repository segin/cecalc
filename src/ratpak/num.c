...
void addnum( PNUMBER *pa, PNUMBER b, unsigned long nRadix )
...
void mulnum( PNUMBER *pa, PNUMBER b, unsigned long nRadix )
...
void divnum( PNUMBER *pa, PNUMBER b, unsigned long nRadix )
